...
<html>
	<head>
		...
		<script type="text/javascript" src="__ROOT__/Index/Common/js/sweetalert.min.js"></script>
		...
		<script type="text/javascript">
			var app = '';
			var srcs = "__ROOT__/Index/Common/images/productDetail/product.jpg";
		</script>
	</head>
	<body ng-app="myapp">
		<div class="navigator">
...
<script type="text/javascript">
	...
	window.onload=function(){
		...
		<!--商品展示-->
		<div class="productDetail" ng-controller="mycontroller" >
			<div class="detail_link">
				<ul>
					...
					<li ng-model="data.productName"><div ng-bind="data.productName"></div></li>
				</ul>
			</div>
			<!--商品主要内容-->
			<div class="main">
					...
					<div class="main_intro">
						...
						<div class="main_show">
							...
							<div class="share">
								...
								<div class="sc"><a href="javascript:;" id="red"><span></span>收藏</a></div>
								<div class="xf_box">
									<div class="title">
						...
						<div class="goods-data">
							<h1 class="clearfix" ng-model="data.productName"><div ng-bind="data.productName"></div></h1>
							<dl class="goods-price afterfl">
								<dt>达令价</dt>
								<dd>
									<div class="afterfl">
										<div class="fl">￥<span class="f30 bold" ng-model="data.discountPrice"><span ng-bind="data.discountPrice"></span></span></div>
									</div>
									<p>海外现时售价
										<span ng-model="data.originPrice"><span ng-bind="data.originPrice"></span></span>
										<span class="price-off" ng-model="data.discountRate"><span ng-bind="data.discountRate"></span>折</span>
									</p>
								</dd>
							</dl>
							...
							<dl class="goods-number afterfl">
								...
								<dd>
									<div class="number">
										...
										<input value="" ng-model="num"/>
									</div>
								</dd>
							</dl>
							<div class="goods-btn afterfl">
								<a href="#">立即购买</a>
								<a href="javascript:;" id="Bt2" ng-click="addCart()">添加到购物车</a>
							</div>
						...
						<div class="tag" id="tags">
							<div class="tag_1">
								<div class="tag_right">
									...
									<a href="javascript:;" id="Bt1">添加到购物车</a>￥
									<span>139.00</span>
								</div>	
								<ul class="afterfl">
									<li class="li_1" id="li1">
										<span class="ico">
											<span></span>
										</span>
										<a href="javascript:;">商品信息</a>
									</li>
									<li  class="li_2" id="li2">
										<span class="ico">
											<span></span>
										</span>
										<a href="javascript:;">用户评论(<span>207</span>)</a>
									</li>
									<li  class="li_3" id="li3">
										<span class="ico">
											<span></span>
										</span>
							...
							<div class="content_info">
								...
								<div class="content_info_1">
									<dl>
										<dt>商品参数</dt>
										<dd>
											<span ng-bind="data.productParamter" style=";word-wrap:break-word;white-space:normal;"></span>
										</dd>
									</dl>
								</div>
								<!--商品展示-->
										...
										<dd>
											...
											<div>
												<div class="comment-table">
													<ul>
														<li class="afterfl" ng-repeat="(k,v) in commentObj.common1">
															<div class="face">
																<img src="http://img.cdn.daling.com/data/files/avator/2016/10/17/14766959758999.jpg"/>
																<p>{{v['common_1.name ']}}</p>
															</div>
															<div class="data afterfl">
																<div class="infos afterfl">
																	...
																	<div class="time">评论时间：
																		<span>{{v['common_1.addtime']}}</span>
																	</div>
																</div>
																<p class="text">{{v['common_1.content ']}}</p>
															</div>
														</li>
													</ul>
												</div>
				...
				<div class="main_right">
					<div class="sidebar-buying">
						...
						<ul style="height: 400px;overflow: hidden;">
							<li class="active">
								<a href="">
									<div class="cover-img">
										<img ng-src="{{img}}" alt="" class="img-ct"/>
									</div>
									<p class="goods-price">¥<span ng-bind="data.discountPrice"></span>
										<span class="old-price">¥<span ng-bind="data.originPrice"></span></span>
									</p>
									<p class="goods-title" ng-bind="data.productName"></p>
								</a>
							</li>
							<li class="active">
								<a href="">
